...
- Fix: currently, when using "touch" and sliding down the keyboard there is no sound (instead user must first release previous key and start new press on next key)
