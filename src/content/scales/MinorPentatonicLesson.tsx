    ...
    <ScaleLessonProvider defaultRootPc={DEFAULT_ROOT_PC} degrees={PENTATONIC}>
      <section className="mt-8" aria-label="Minor pentatonic lesson">
        ...
        <P>
          ...
          stay silent. Press <Mono>Play</Mono>, then press the green keys in
          any order you like, fast or slow. Notice that you cannot make it
          sound wrong. That is the whole point of the scale, and section 3
          explains why.
        </P>
        <div className="mt-4 space-y-3">
          <LessonToolbar root octave lock>
            <PlayPatternButton label="Play the scale" offsets={PENTATONIC_OFFSETS} />
          </LessonToolbar>
        ...
        <P>
          ...
          <Term id="flats-and-sharps">flat</Term> (<Mono>♭</Mono>) in front of
          a number means &ldquo;that note, one key lower.&rdquo;
        </P>
        ...
        <P>
          ...
          <Mono>♭7</Mono> follows it. And two of the major scale&rsquo;s
          degrees are simply not here: no <Mono>2</Mono>, no <Mono>6</Mono>.
          Click a chip to hear each degree in <RootName />.
        </P>
        <DegreeStrip degrees={PENTATONIC} spotlightOffset={FLAT_THIRD} className="mt-4" />

        {/* ---------------------------------------------------------------- */}
        <H2 id="no-clash">3. Why nothing clashes</H2>
        <P>
          Look at the gaps between neighbours. <Mono>1</Mono> to{" "}
          <Mono>♭3</Mono> is three keys. <Mono>♭3</Mono> to <Mono>4</Mono> is
          two. <Mono>4</Mono> to <Mono>5</Mono>, two. <Mono>5</Mono> to{" "}
          <Mono>♭7</Mono>, three. <Mono>♭7</Mono> back to the octave, two.
          Every gap is at least a whole step. There is not a single half step
          anywhere in the scale — no two notes sit on adjacent keys.
        </P>
        <P>
          Half steps are where friction lives. Two notes one key apart rub
          against each other; a melody that lands on one usually has to move
          to the other. The major scale has two such pairs and natural minor
          has two, and a beginner who lands on the wrong side of one hears a
          &ldquo;mistake.&rdquo; The minor pentatonic has none. Whatever note
          you land on, its neighbours are far enough away that it can sit
          there. Press the two runs below: the first is the scale, the second
          walks up all twelve keys in a row. Hear how much rougher the second
          is.
        </P>
        <div className="mt-4">
          <LessonToolbar octave>
            <PlayPatternButton label="Five notes, no friction" offsets={PENTATONIC_OFFSETS} descend={false} />
            <PlayPatternButton
        ...
        {/* ---------------------------------------------------------------- */}
        <H2 id="from-minor">4. Where the five come from: natural minor, two notes removed</H2>
        <P>
        ...
        <ScaleComparer
          ...
          b={{ id: "pentatonic", name: "Minor pentatonic", degrees: PENTATONIC }}
          defaultSide="b"
        />
        <P>
          That is a useful way to think about any pentatonic: a seven-note
          scale with its trouble spots taken out. It is also why the scale is
          so forgiving over a chord progression — the notes most likely to
          clash with a passing chord are exactly the ones that are not there.
        </P>

        {/* ---------------------------------------------------------------- */}
        <H2 id="major-pentatonic">5. Same keys, different home: the major pentatonic</H2>
        <P>
          Now the map view. Take the five keys of <RootName /> minor
          pentatonic and, without turning any on or off, call the{" "}
          <Mono>♭3</Mono> home instead. You are now playing the{" "}
          ...
          white keys, settling somewhere brighter. Flip the toggle and only
          the green <Mono>1</Mono> moves.
        </P>
        <ScaleComparer
          className="mt-4"
          a={{ id: "minor-pent", name: "Minor pentatonic", degrees: PENTATONIC }}
          b={{
            id: "major-pent",
        ...
        <P>
          ...
          <LessonLink href="/scales/major-scale">major scale</LessonLink> to
          its relative minor, three keys down.
        </P>
        ...
        <ScaleComparer
          className="mt-4"
          a={{ id: "pentatonic", name: "Minor pentatonic", degrees: PENTATONIC }}
          b={{ id: "blues", name: "Blues scale", degrees: BLUES, spotlightOffset: BLUE_NOTE_OFFSET }}
        />
        ...
        <P>
          ...
          that matters most for the music on this site runs through the last
          of those: the ethnomusicologist Gerhard Kubik traces the pentatonic
          habits of pitch in West African song into the work songs, field
          hollers, and spirituals of the American South, and from there into
          the blues. The blues scale — this scale plus its{" "}
          <Term id="blue-notes">blue note</Term> — is where that lineage is
          easiest to hear. <LessonLink href="/history/blues">Where did the blues come from?</LessonLink>{" "}
        ...
        <P>
          Keep the lock on and play. With the lock on there are no wrong
          notes, so stop thinking about which key and start thinking about
          rhythm and shape — short phrases, a rest, a reply. Land on{" "}
          <Mono>1</Mono> to finish a thought and on <Mono>5</Mono> to leave it
          open. Pick the root that matches your song; guitar blues and rock
          usually live in <Mono>A</Mono> or <Mono>E</Mono>. When the five
          start to feel too polite, go to{" "}
          <LessonLink href="/scales/blues-scale">What is the blues scale?</LessonLink>{" "}
          and add the sixth note.
        </P>
        <div className="mt-4">
          <LessonToolbar octave lock>
            <PlayPatternButton label="Play the minor pentatonic" offsets={PENTATONIC_OFFSETS} />
          </LessonToolbar>
        </div>
