    ...
    <ScaleLessonProvider defaultRootPc={DEFAULT_ROOT_PC} degrees={PHRYGIAN}>
      <section className="mt-8" aria-label="Phrygian lesson">
        ...
        <P>
          ...
          the very first step. Every other scale on this site opens with a
          whole step or wider. Phrygian opens with a half step — the smallest
          move a piano can make — and that cramped first step colours
          everything after it.
        </P>
        <div className="mt-4 space-y-3">
          <LessonToolbar root octave lock>
            <PlayPatternButton label="Play the scale" offsets={PHRYGIAN_OFFSETS} />
          </LessonToolbar>
        ...
        <P>
          ...
          <Mono>♭6</Mono>, <Mono>♭7</Mono> — are the ones natural minor
          lowers too; they make the scale minor. The fourth is the one that
          makes it Phrygian: the <Mono>♭2</Mono>, in <RootName /> the key{" "}
          <NoteAt offset={FLAT_SECOND} />, sitting directly above home. Click
          a chip to hear each degree.
        </P>
        <DegreeStrip degrees={PHRYGIAN} spotlightOffset={FLAT_SECOND} className="mt-4" />

        {/* ---------------------------------------------------------------- */}
        <H2 id="flat-two">3. The ♭2: a note that leans on home</H2>
        <P>
          Play <NoteAt offset={FLAT_SECOND} /> and hold it. It cannot sit
          still. A note one key above the root is pulled down onto it the way
          the major scale&rsquo;s <Mono>7</Mono> is pulled up — Phrygian has
          a leading tone, but it leads from <em>above</em>. Press{" "}
          <Mono>Hear ♭2 fall</Mono>: that downward sigh is the sound most
          people mean when they call a scale &ldquo;Spanish.&rdquo;
        </P>
        <div className="mt-4">
        ...
        <P>
          ...
          down — in <RootName />, <NoteAt offset={MAJOR_SECOND} /> becomes{" "}
          <NoteAt offset={FLAT_SECOND} /> — and natural minor becomes
          Phrygian. Flip the toggle and play both. Natural minor opens with a
          step you can walk. Phrygian opens with a step you fall down.
        </P>
        <ScaleComparer
          className="mt-4"
        ...
        {/* ---------------------------------------------------------------- */}
        <H2 id="same-keys">4. Same keys, different home: a major scale from its third</H2>
        <P>
          Now the map view. Take the seven keys of <RootName /> Phrygian and,
          without turning any on or off, call the <Mono>♭6</Mono> home
          ...
          — the same white keys, settling somewhere bright. Flip the toggle
          and only the green <Mono>1</Mono> moves.
        </P>
        <ScaleComparer
          className="mt-4"
        ...
        />
        <P>
          Western theory calls Phrygian the third <Term id="mode">mode</Term>{" "}
          of the major scale — the major scale started from its third degree.
          The half step that opens Phrygian is the major scale&rsquo;s{" "}
        ...
        <P>
          ...
          player&rsquo;s second position, and the reason is exactly the ♭2:
          most of the tunes a harp gets pulled out for do not want that note.
          When they do, the{" "}
          <LessonLink href="/harmonica-lab/v2?position=5">Harmonica Lab</LessonLink>{" "}
          shows which holes give the scale in fifth position for any harp.
        </P>

        {/* ---------------------------------------------------------------- */}
        <H2 id="raise-the-third">6. Close, but not the sound: raise the third</H2>
        <P>
          ...
          instead of the minor one. Raise the <Mono>♭3</Mono> — in{" "}
          <RootName />, <NoteAt offset={FLAT_THIRD} /> becomes{" "}
          <NoteAt offset={MAJOR_THIRD} /> — and Phrygian becomes{" "}
          <LessonLink href="/scales/freygish">freygish</LessonLink>, also
          called Phrygian dominant. Flip the toggle and listen to the second
          step of the run. Phrygian walks up gently. Freygish stretches — the
          gap from <Mono>♭2</Mono> to <Mono>3</Mono> is now an{" "}
          <Term id="augmented-second">augmented second</Term>, and that
          stretch is the sound.
        </P>
        <ScaleComparer
          className="mt-4"
          a={{ id: "phrygian", name: "Phrygian", degrees: PHRYGIAN }}
        ...
        />
        <P>
          So think of Phrygian as the doorway. It has the leaning ♭2 and
          none of the stretch, which makes it darker and more even-tempered
          than freygish — good for a brooding metal riff or a slow modal
          vamp, less good for a wedding dance. When you want the leap,{" "}
        ...
        <P>
          Keep the lock on and play the green keys over a held root. End
          phrases on <Mono>1</Mono> and arrive from <Mono>♭2</Mono> above —
          that is the signature. Try holding <Mono>1</Mono> in the low octave
          while the right hand walks <Mono>♭2 1 ♭2 1</Mono>: the smallest
          possible two-note riff, and unmistakably this mode. Then decide
          whether you wanted the stretch after all, and go raise the third.
        </P>
        <div className="mt-4">
          <LessonToolbar octave lock>
            <PlayPatternButton label="Play Phrygian" offsets={PHRYGIAN_OFFSETS} />
          </LessonToolbar>
        </div>
      </section>
    </ScaleLessonProvider>
